...
import { Menu, Tooltip, Steps, Input, notification, Slider, Typography, Layout, Icon, Col, Radio, Form, Row, Button, Checkbox, InputNumber } from 'antd';
...
const AddedFeatureMsg = "You turned on a new feature";
const RemoveFeatureMsg = "You turned off feature";
const WaitMsg = "Your video is being processing, Please wait until the new video is generated";
                ...
                <div style={{ padding: "1rem" }}>
                  <div className="docs-example" style={{ height: "100%" }}>
                    ...
                    {this.state.displayRotate ? (
                      <div>
                        <div id={"RotatePlayerValue" + this.state.RotateValue} >
                              <Player ref="player" videoId="video-1" >
                                <source src={this.state.playerSource} />
                              </Player>
                        </div>
                ...
                <Col span={8}>
                  ...
                  <Col span={10}>
                    <Button
                      ...
                      onClick={e => {
                        this.disableAudio();
                        showNotificationWithIcon("success", AddedFeatureMsg);
                      }}
                  ...
                  <Col span={10}>
                    <Button
                      ...
                      onClick={e => {
                        ...
                        showNotificationWithIcon("info", AddedFeatureMsg);
                      }}
                      style={{ margin: "1rem", marginLeft: "2.25rem" }}
                    >
                      <Icon type="undo" /> Undo
